                    ...
                    <div class="col-sm-12">
                      <div class="card">
                        <div class="card-header pb-0">
                            <h4 style="font-size: 18px">Create New Department</h4>
                        </div>
                        <div class="card-block mt-0 pt-0">
                            ...
                            <form method="POST" action="{{ route('departments.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    >
                                    <div class="col-sm-10">
                                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g Accounts" required="" />
                                    </div>
                                    @error('name')
