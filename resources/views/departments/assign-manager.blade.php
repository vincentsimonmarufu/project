                    ...
                    <div class="col-sm-12">
                      <div class="card">
                        <div class="card-header pb-0">
                            <h4 style="font-size: 18px">Assign Department Manager</h4>
                            <p>Please select employee pay number first for the department to be generated</p>
                        </div>
                        <div class="card-block mt-0 pt-0">
                            <h4 class="sub-title"></h4>
                            <form method="POST" action="{{ url('assign-manager-post') }}" class="needs-validation">
                                @csrf
                                @method('POST')
                                ...
                                <div class="form-group row">
                                    <label for="check" class="col-sm-3 col-form-label"
                                        >Position : </label
                                    >
                                    <div class="col-sm-4">

                                        <div class="form-check form-check-inline pt-2">
                                            <input class="form-check-input" type="radio" name="check" id="inlineRadio1" value="manager">
                                            <label class="form-check-label" for="inlineRadio1">Manager</label>
                                          </div>
                                        <div class="form-check form-check-inline pt-2">
                                            <input class="form-check-input" type="radio" name="check" id="inlineRadio2" value="assistant">
                                ...
                                <div class="form-group row justify-content-end">
                                    <button class="btn waves-effect btn-round waves-light btn-sm mr-4 btn-primary">Assign Manager</button>
                                </div>
                            </form>
                        </div>
                      </div>
